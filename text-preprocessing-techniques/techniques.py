...
with open('/drive/MyDrive/TextMiningProject/text-preprocessing-techniques/slang.txt') as file:
...
WORDS = Counter(words(open('/drive/MyDrive/TextMiningProject/text-preprocessing-techniques/corporaForSpellCorrection.txt').read()))
